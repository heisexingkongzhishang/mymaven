    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="header-navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active new-nav logo-1111">
                    <a href="../vip/index.html">上传动漫</a>
...
<ol class="breadcrumb">
    ...
    <div class="content course-infobox">
        ...
        <div class="clearfix course-infobox-body">
            ...
            <div id="videoshow" class="course-infobox-progress">
            	...
            	<!-- 上传动漫表单 -->
            	<form role="form" action="${pageContext.request.contextPath}/uploadVideo.html" method="post" enctype="multipart/form-data">
				<div class="form-group">
					 <label for="exampleInputEmail1">动漫名称</label><input class="form-control" id="video_name" name="video_name" type="text" />
				</div>
				<div class="form-group">
					 <label for="exampleInputPassword1">动漫简介</label>
					 <textarea class="form-control" rows="8"cols="50" id="video_introduce" name="video_introduce"></textarea>
				</div>
				<select id="videotype_idstr" name="videotype_idstr">
				  <option value ="1">奇幻</option>
				  <option value ="2">魔幻</option>
				  <option value="3">异界</option>
				  <option value="4">后宫</option>
				  <option value="5">铁疙瘩互殴</option>
				  <option value="6">热血拳头</option>
				  <option value="7">运动</option>
				  <option value="8">脑残</option>
				  <option value="9">萌</option>
				  <option value="10">诡异</option>
				  <option value="11">推理</option>
				  <option value="12">治愈</option>
				  <option value="13">治郁</option>
				</select>
				<div class="form-group">
					 <label for="exampleInputFile">动漫首页图片上传</label><input id="video_image" name="video_image" type="file" accept='image/*'/>
					<p class="help-block">
						请提交jpg或png格式的图片。
					</p>
				</div>
				<div class="form-group">
					<div id="uploaderBox" class="weui-uploader__input"><lable for="exampleInputFile">动漫上传(有本事点我吖)</lable></div>
					 <p class="help-block">
						请提交完整的动漫集数，仅限MP4格式。
					</p>
				</div>
    ...
    <div class="content">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="active">
                <a href="#labs" aria-controls="labs" role="tab" data-toggle="tab">666</a>
            </li>
            
            <li role="presentation">
                <a href="#reports" class="stat-event" data-stat="course_report" aria-controls="reports" role="tab" data-toggle="tab">2333</a>
            </li>
        </ul>
    ...
    <div class="lab-item ">
    <div class="lab-item-index">666666666666666666666666666666666(滑稽)</div>
</div>
            ...
            <div role="tabpanel" class="tab-pane" id="reports">
				<div class="lab-item-index">233333333333333(滑稽)</div>
    ...
    <div class="text-center copyright">
        ...
        <script type="text/javascript">
        	$("#uploaderBox").on("click", function(e) {
			       var newFileInput = "<input id='uploaderInput' type='file' name='video_files' accept='video/mp4' multiple />";
